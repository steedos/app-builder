...
const defaultAddNewRecord = async (objectApiName:string, formData:any) =>{
...
export type ObjectContextValueType = {
  ...
  addNewRecord: (objectApiName:string, formData:any ) => Promise<object | Error>
}
...
export const ObjectContext = React.createContext<ObjectContextValueType>({
  ...
  addNewRecord: defaultAddNewRecord
});
